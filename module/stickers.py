                    ...
                    [
                        [
                            InlineKeyboardButton(
                                text="بدء", url=f"t.me/{context.bot.username}",
                            ),
                        ],
                    ],
                ),
...
__help__ = """
  • `/stickerid`*:* رد على ملصق ليعطيك آيدي ملفه.
  • `/getsticker`*:* رد على ملصق لرفع ملفه بصيغة PNG الأصلية.
  • `/kang`*:* رد على ملصق لإضافته لحزمتك.
  • `/stickers`*:* بحث عن ملصقات لكلمة معينة في كتالوج ملصقات combot
  """
