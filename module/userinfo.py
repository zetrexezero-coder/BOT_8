...
__help__ = """
  *الآيدي:*
   • `/id`*:* الحصول على آيدي القروب الحالي. إذا استُخدم كرد على رسالة، يعرض آيدي ذلك المستخدم.
   • `/gifid`*:* رد على صورة متحركة ليعطيك آيدي ملفها.

  *معلومات ذاتية:*
   • `/setme <نص>`*:* يعيّن معلوماتك
   • `/me`*:* يعرض معلوماتك أو معلومات مستخدم آخر.
  أمثلة:
   `/setme أنا ذئب.`
   `/me @username(يعرض معلوماتك إذا لم تحدد مستخدماً)`

  *معلومات يضيفها الآخرون عنك:*
   • `/bio`*:* يعرض سيرتك أو سيرة مستخدم آخر. لا يمكنك تعيينها بنفسك.
  • `/setbio <نص>`*:* بالرد، يحفظ سيرة مستخدم آخر
  أمثلة:
   `/bio @username(يعرض سيرتك إذا لم تحدد أحداً).`
   `/setbio هذا المستخدم ذئب` (رد على المستخدم)

  *معلومات شاملة عنك:*
   • `/info`*:* الحصول على معلومات عن مستخدم.

  *ما هذا الشيء المتعلق بالصحة؟*
   تفضل بمشاهدة [شرح نظام الصحة HP](https://t.me/OnePunchUpdates/192)
  """
