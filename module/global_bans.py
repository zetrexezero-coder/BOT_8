...
__help__ = """
  *للمشرفين فقط:*
   • `/antispam <on/off/yes/no>`*:* تفعيل أو تعطيل تقنية مكافحة الإسبام، أو عرض إعداداتك الحالية.

  مكافحة الإسبام، يستخدمها مطورو البوت لحظر المسبمين عبر جميع القروبات. هذا يساعد على حمايتك   وقروباتك بإزالة المسبمين بأسرع وقت ممكن.
  *ملاحظة:* يمكن للمستخدمين الاستئناف على الحظر العام أو تبليغ المسبمين في @{SUPPORT_CHAT}

  هذا يدمج أيضاً @Spamwatch API لإزالة المسبمين بقدر الإمكان من قروبك!
  *ما هو SpamWatch؟*
  يحتفظ SpamWatch بقائمة حظر ضخمة تُحدَّث باستمرار لبوتات السبام والمشاغبين ومسبمي البيتكوين والشخصيات المشبوهة[.](https://telegra.ph/file/f584b643c6f4be0b1de53.jpg)
  يساعد باستمرار على حظر المسبمين من قروبك تلقائياً حتى لا تقلق بشأن اقتحام المسبمين لقروبك.
  *ملاحظة:* يمكن للمستخدمين الاستئناف على حظر spamwatch في @SpamwatchSupport
  """
